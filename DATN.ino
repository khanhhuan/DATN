...
#include <a26-10-2024_inferencing.h>  // replace with your cloud classification Edge Impulse library
...
void loop() {
  ...
  // Check if the image is classified as "Cloudy" or "Clear"
  if (result == "Cloudy") {
    Serial.println("The image contains clouds.");
  } else if (result == "Clear") {
    Serial.println("The image does not contain clouds.");
  } else {
    Serial.println("Uncertain classification.");
  }

  delay(15000);  // Wait for 15 seconds before capturing next image
}
